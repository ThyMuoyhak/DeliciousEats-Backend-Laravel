...
@section('content')
    <h1 class="text-3xl font-bold mb-8" data-aos="fade-up" data-aos-duration="1000">Compose Message</h1>
    ...
    <div class="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="1200">
        <form action="{{ route('messages.store') }}" method="POST">
            ...
            <!-- Subject -->
            <div class="mb-4" data-aos="fade-up" data-aos-duration="1400">
            ...
            <!-- Submit Button -->
            <div class="mt-6" data-aos="fade-up" data-aos-duration="1600">
