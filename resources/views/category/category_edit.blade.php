...
<div class="container mx-auto px-4 py-8 bg-gray-900 text-gray-100 min-h-screen" data-aos="fade-up">
    <h1 class="text-2xl font-bold mb-6" data-aos="fade-down">Edit Category</h1>
    ...
    <!-- Edit Category Form -->
    <form action="{{ route('categories.update', $category->cat_id) }}" method="POST" class="max-w-md" data-aos="fade-up" data-aos-delay="200">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cat_name" id="cat_name" value="{{ old('cat_name', $category->cat_name) }}" required
                   class="shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline bg-gray-800 text-gray-200 placeholder-gray-500">
            @error('cat_name')
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function(event) {
        ...
        console.log('cat_name:', document.querySelector('#cat_name').value);
    });
</script>
@endpush